...
static inline void add_move(move_t *moves, size_t *count, bindex_t from,
                            bindex_t to, movetype_t mt) {
    moves[(*count)++] = pack_move(from, to, mt);
}

static inline void add_promotions(move_t *moves, size_t *count, bindex_t from,
                                  bindex_t to) {
...
static inline void insert_mask_moves(move_t *moves, size_t *count,
                                     bindex_t from, bb_t mask,
